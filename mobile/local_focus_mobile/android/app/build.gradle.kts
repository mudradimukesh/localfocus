...
// Release signing credentials live in android/key.properties (kept out of git).
// When it is absent (e.g. a fresh clone) the release build falls back to the
// debug key so it still builds.
